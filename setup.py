...
with open('README.md', 'r') as fh:
    ...
    setup(
        name='notification_core_lib',
        version=notification_core_lib.__version__,
        author='Shay Tessler',
        author_email='shay.te@gmail.com',
        description='manage notification for users',
        long_description=long_description,
        long_description_content_type='text/markdown',
        url='https://github.com/shay-te/notification-core-lib',
        packages=packages,
        license='MIT',
