...
from notification_core_lib.notification_core_lib import NotificationCoreLib
...
def sync_create_start_core_lib() -> NotificationCoreLib:
    threadLock.acquire()
    if not OblInstance.instance:
        try:
            ...
            OblInstance.instance = NotificationCoreLib(load_config())
